...
class FormularioApiConfig:
    def __init__(self, root):
        self.root = root
        self.root.title("Configuración de URLs - ST60")
        ...
        # ST60 invoca 4 APIs. Orden segun la caja "APIs to use" del Modulo de
        # Configuracion (apartado 1.1 Flowchart) del PDF TLA_E34_ST60:
        #   PARENTAGE (GET) -> INTERLOCKING (POST) -> TRACEABILITY (POST) -> CONDUIT (POST)
        # Nota: CONDUIT se invoca varias veces en el proceso (Add Meas Key, Record
        # Defect, Repair, End) pero es UNA sola URL, por eso aparece una vez.
    ...
    def _setup_ui(self):
        ...
        tk.Label(header, text="⚙ Configurador de URLs - ST60",
    ...
    def cargar_configuracion(self):
        """Lee url_data y precarga el valor de cada API de ST60.
    ...
    def guardar_todo(self):
        ...
        # (parentage -> interlocking -> traceability -> conduit).
