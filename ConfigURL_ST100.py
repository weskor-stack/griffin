...
class FormularioApiConfig:
    def __init__(self, root):
        self.root = root
        self.root.title("Configuración de URLs - ST100")
        ...
        # ST100 invoca 3 APIs. Orden segun la Tabla 2.1 "API List" del PDF TLA_E34_ST100:
        #   UNIT (GET) -> INTERLOCKING (POST) -> TRACEABILITY (POST)
        # Nota: ST100 NO llama a CONDUIT (el PDF dice "6 API's" por error de copy-paste,
        # pero la Tabla 2.1 lista solo estas 3). Igual que ST50/80.
    ...
    def _setup_ui(self):
        ...
        tk.Label(header, text="⚙ Configurador de URLs - ST100",
    ...
    def cargar_configuracion(self):
        """Lee url_data y precarga el valor de cada API de ST100.
    ...
    def guardar_todo(self):
        ...
        # (unit -> interlocking -> traceability).
