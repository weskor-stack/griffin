...
class FormularioApiConfig:
    def __init__(self, root):
        self.root = root
        self.root.title("Configuración de URLs - ST40")
        ...
        # ST40 invoca 6 APIs. Orden segun la Tabla 2.1 "API List" del PDF TLA_E34_ST40:
        #   SHOP ORDER (GET) -> PARENTAGE (GET) -> UNIT (GET) -> INTERLOCKING (POST)
        #   -> CONDUIT (POST) -> TRACEABILITY (POST)
    ...
    def _setup_ui(self):
        ...
        tk.Label(header, text="⚙ Configurador de URLs - ST40",
    ...
    def cargar_configuracion(self):
        """Lee url_data y precarga el valor de cada API de ST40.
